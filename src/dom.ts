...
export const createSizeWrapperElement = async (
  ...
  <details id="${MODAL_ID}-size-stat-wrapper" class="details-reset details-overlay details-overlay-dark">
    <summary>
      <a id="${MODAL_ID}-size-stat-content" class="pl-3 pr-3 py-3 p-md-0 mt-n3 mb-n3 mr-n3 m-md-0 Link--primary no-underline no-wrap" title="Reported by the GitHub API, actual size may differ.">
