  ...
  if (repoSlug != null) {
    ...
    if (repoSizeElt == null) {
      ...
      .then(repoSize => {
        ...
        const sizeTag = document.createElement('li')
        sizeTag.id = REPO_SIZE_ID
        sizeTag.innerHTML = sizeHTML

        statsElt.append(sizeTag)
      })
    }
  }
}
